...
# axes.W006 советует добавить 'ip_address' в параметры локаута. Для нас это
# сознательный выбор: лочим по логину (телефону), который атакующий не может
# «вращать», не сменив саму цель атаки. Предупреждение неактуально — глушим.
