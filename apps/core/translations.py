...
TR = {
    ...
    'l_reg_b1_t':       {'ru': 'Бесплатный тариф навсегда', 'uz': 'Umrbod bepul tarif', 'en': 'Free plan forever'},
    'l_reg_b1_d':       {'ru': 'Карта не нужна, оборудование не нужно.', 'uz': 'Karta va uskunalar talab qilinmaydi.', 'en': 'No card needed, no hardware needed.'},
