...
TR = {
    ...
    'nav_start':        {'ru': 'Оставить заявку', 'uz': 'Ariza qoldirish', 'en': 'Leave a request'},

    # заявка с лендинга (самостоятельной регистрации нет)
    'lead_title':       {'ru': 'Оставить заявку', 'uz': 'Ariza qoldirish', 'en': 'Leave a request'},
    'lead_subtitle':    {'ru': 'Заполните форму — мы свяжемся и подключим ваше заведение.', 'uz': 'Shaklni toʻldiring — biz bogʻlanib, muassasangizni ulaymiz.', 'en': 'Fill in the form — we’ll get in touch and connect your venue.'},
    'lead_name':        {'ru': 'Ваше имя', 'uz': 'Ismingiz', 'en': 'Your name'},
    'lead_venue':       {'ru': 'Название заведения', 'uz': 'Muassasa nomi', 'en': 'Venue name'},
    'lead_comment':     {'ru': 'Комментарий', 'uz': 'Izoh', 'en': 'Comment'},
    'lead_submit':      {'ru': 'Отправить заявку', 'uz': 'Arizani yuborish', 'en': 'Send request'},
    'lead_sent':        {'ru': 'Заявка принята — мы скоро свяжемся с вами.', 'uz': 'Ariza qabul qilindi — tez orada bogʻlanamiz.', 'en': 'Request received — we’ll contact you soon.'},

    # агентский кабинет
    'agent_title':      {'ru': 'Агентский кабинет', 'uz': 'Agent kabineti', 'en': 'Agent dashboard'},
    'agent_subtitle':   {'ru': 'Подключённые вами заведения', 'uz': 'Siz ulagan muassasalar', 'en': 'Venues you connected'},
    'agent_add':        {'ru': 'Подключить заведение', 'uz': 'Muassasa ulash', 'en': 'Connect a venue'},
    'agent_empty':      {'ru': 'Вы ещё не подключили ни одного заведения', 'uz': 'Hali birorta muassasa ulamadingiz', 'en': 'You haven’t connected any venues yet'},
    'agent_count':      {'ru': 'Заведений', 'uz': 'Muassasalar', 'en': 'Venues'},
    'agent_owner_phone': {'ru': 'Телефон входа', 'uz': 'Kirish telefoni', 'en': 'Login phone'},
    'agent_reset_pw':   {'ru': 'Сбросить пароль', 'uz': 'Parolni tiklash', 'en': 'Reset password'},
    'agent_new_title':  {'ru': 'Подключить заведение', 'uz': 'Muassasa ulash', 'en': 'Connect a venue'},
    'agent_new_sub':    {'ru': 'Заведите аккаунт владельцу — он войдёт по телефону и паролю', 'uz': 'Egasiga akkaunt yarating — u telefon va parol bilan kiradi', 'en': 'Create the owner’s account — they log in with phone and password'},
    'agent_client_name': {'ru': 'Имя владельца (необязательно)', 'uz': 'Egasining ismi (ixtiyoriy)', 'en': 'Owner name (optional)'},
    'agent_phone_taken': {'ru': 'Этот номер уже зарегистрирован', 'uz': 'Bu raqam allaqachon roʻyxatda', 'en': 'This number is already registered'},
    'agent_created':    {'ru': 'Заведение подключено', 'uz': 'Muassasa ulandi', 'en': 'Venue connected'},
    'agent_create_btn': {'ru': 'Подключить', 'uz': 'Ulash', 'en': 'Connect'},
    'agent_back':       {'ru': '← К заведениям', 'uz': '← Muassasalarga', 'en': '← Back to venues'},
    'agent_pw_reset_title': {'ru': 'Новый пароль владельца', 'uz': 'Egasining yangi paroli', 'en': 'New owner password'},
    'agent_pw_reset_ok': {'ru': 'Пароль обновлён', 'uz': 'Parol yangilandi', 'en': 'Password updated'},
    'agent_logout':     {'ru': 'Выйти', 'uz': 'Chiqish', 'en': 'Log out'},
    ...
    'menu_all':         {'ru': 'Все', 'uz': 'Hammasi', 'en': 'All'},
    'menu_th_dish':     {'ru': 'Блюдо', 'uz': 'Taom', 'en': 'Dish'},
    'menu_th_price':    {'ru': 'Цена', 'uz': 'Narx', 'en': 'Price'},
    'menu_th_avail':    {'ru': 'Наличие', 'uz': 'Mavjudligi', 'en': 'Availability'},
    'menu_cats_count':  {'ru': 'категорий', 'uz': 'kategoriya', 'en': 'categories'},
    'menu_dishes_count': {'ru': 'блюд', 'uz': 'taom', 'en': 'dishes'},
    'menu_avail_count': {'ru': 'в наличии', 'uz': 'mavjud', 'en': 'available'},
    'menu_edit_dish':   {'ru': 'Редактировать блюдо', 'uz': 'Taomni tahrirlash', 'en': 'Edit dish'},
    'mk_orders_today':  {'ru': 'Заказов сегодня', 'uz': 'Bugun buyurtma', 'en': 'Orders today'},
    'mk_revenue':       {'ru': 'Выручка', 'uz': 'Tushum', 'en': 'Revenue'},
    'mk_avg':           {'ru': 'Средний чек', 'uz': 'Oʻrtacha chek', 'en': 'Average check'},
    'mk_hit':           {'ru': 'Хит дня', 'uz': 'Kun xiti', 'en': 'Hit of the day'},
    'mk_no_hit':        {'ru': 'пока нет', 'uz': 'hozircha yoʻq', 'en': 'none yet'},
    ...
    'design_card_featured': {'ru': 'Крупно', 'uz': 'Yirik', 'en': 'Featured'},
    ...
    'ord_accept':       {'ru': 'Принять →', 'uz': 'Qabul →', 'en': 'Accept →'},
    'ord_dine_in':      {'ru': 'в зале', 'uz': 'zalda', 'en': 'dine-in'},
    'ord_takeaway':     {'ru': 'навынос', 'uz': 'olib ketish', 'en': 'takeaway'},
    'ord_live':         {'ru': 'Обновляется в реальном времени', 'uz': 'Real vaqtda yangilanadi', 'en': 'Updates in real time'},
    ...
    # hero
    'l_hero_badge':     {'ru': 'QR-меню для общепита Узбекистана', 'uz': 'Oʻzbekiston restoran va kafelari uchun QR-menyu', 'en': 'QR menu for Uzbekistan’s food service'},
    'l_hero_h1':        {'ru': 'Меню, которое гость открывает', 'uz': 'Mijoz bitta skanerlash orqali', 'en': 'A menu your guest opens'},
    'l_hero_h1_accent': {'ru': 'за один скан', 'uz': 'ochadigan menyu', 'en': 'in a single scan'},
    'l_hero_sub':       {'ru': 'Гость наводит камеру на QR на столе — и заказывает сам, на родном языке. Вы управляете меню и заказами из одного кабинета. Без приложений и регистрации гостя.', 'uz': 'Mijoz stoldagi QR-kodga kamerasini qaratadi va oʻz ona tilida mustaqil buyurtma beradi. Siz esa menyu va buyurtmalarni bitta kabinetdan boshqarasiz. Hech qanday ilovalar va roʻyxatdan oʻtishlarsiz.', 'en': 'A guest points the camera at the QR on the table and orders by themselves, in their own language. You manage menu and orders from one dashboard. No apps, no guest sign-up.'},
    'l_hero_cta1':      {'ru': 'Оставить заявку', 'uz': 'Ariza qoldirish', 'en': 'Leave a request'},
    ...
    'l_feat_h2':        {'ru': 'Всё для меню и заказов — в одном месте', 'uz': 'Menyu va buyurtmalar uchun barchasi — bitta joyda', 'en': 'Everything for menu and orders — in one place'},
    'l_f1_t':           {'ru': 'QR на каждом столе', 'uz': 'Har bir stolda QR-kod', 'en': 'QR on every table'},
    'l_f1_d':           {'ru': 'Гость сканирует код и сразу видит меню своего стола. Без приложений, без регистрации, без официанта.', 'uz': 'Mijoz kodni skanerlaydi va darhol oʻz stolining menyusini koʻradi. Ilovalarsiz, roʻyxatdan oʻtishsiz va ofitsiantni kutmasdan.', 'en': 'The guest scans the code and instantly sees the menu for their table. No apps, no sign-up, no waiter.'},
    'l_f2_t':           {'ru': 'Три языка из коробки', 'uz': 'Tayyor 3 ta til', 'en': 'Three languages out of the box'},
    'l_f2_d':           {'ru': 'Русский, узбекский (латиница) и английский. Гость выбирает язык — меню переключается целиком.', 'uz': 'Rus, oʻzbek (lotincha) va ingliz tillari. Mijoz tilni tanlaydi — menyu toʻliq oʻsha tilga oʻzgaradi.', 'en': 'Russian, Uzbek (Latin) and English. The guest picks a language and the whole menu switches.'},
    'l_f3_t':           {'ru': 'Цены в сумах', 'uz': 'Narxlar soʻmda', 'en': 'Prices in soʻm'},
    'l_f3_d':           {'ru': 'Крупные читаемые числа в формате «45 000 so‘m». Скидки, стоп-листы и веса порций.', 'uz': '«45 000 so‘m» formatidagi tushunarli yirik raqamlar. Chegirmalar, stop-varaqalar (sotuvda yoʻq taomlar) va porsiya hajmi.', 'en': 'Large, readable numbers like “45 000 so‘m”. Discounts, stop-lists and portion weights.'},
    'l_f4_t':           {'ru': 'Меню без программиста', 'uz': 'Dasturchisiz menyu yaratish', 'en': 'Menu without a developer'},
    'l_f4_d':           {'ru': 'Добавляйте блюда, фото и цены сами. Перетаскивайте порядок, включайте и выключайте позиции в один клик.', 'uz': 'Taomlar, rasm va narxlarni oʻzingiz qoʻshing. Ketma-ketlikni oʻzgartiring, taomlarni bitta tugma orqali yoqing yoki oʻchiring.', 'en': 'Add dishes, photos and prices yourself. Drag to reorder, toggle items on and off in one click.'},
    'l_f5_t':           {'ru': 'Заказы в реальном времени', 'uz': 'Real vaqtdagi buyurtmalar', 'en': 'Real-time orders'},
    'l_f5_d':           {'ru': 'Новые заказы прилетают на кухню мгновенно. Статусы «принят → готовится → готово → подано».', 'uz': 'Yangi buyurtmalar oshxonaga darhol yetib boradi. Holatlar: «qabul qilindi → tayyorlanmoqda → tayyor → tortiq qilindi».', 'en': 'New orders reach the kitchen instantly. Statuses: “accepted → cooking → ready → served”.'},
    'l_f6_t':           {'ru': 'Аналитика продаж', 'uz': 'Sotuvlar tahlili', 'en': 'Sales analytics'},
    'l_f6_d':           {'ru': 'Выручка, средний чек, хиты и аутсайдеры меню. Понимайте, что заказывают и что стоит убрать.', 'uz': 'Tushum, oʻrtacha chek, eng koʻp sotilgan va xaridorgir boʻlmagan taomlar. Mijozlar nima buyurtma qilayotganini va menyudan nimani olib tashlash kerakligini kuzatib boring.', 'en': 'Revenue, average check, bestsellers and weak items. See what’s ordered and what to drop.'},

    # how it works
    'l_how_kicker':     {'ru': 'Как это работает', 'uz': 'Bu qanday ishlaydi', 'en': 'How it works'},
    ...
    'l_how1_d':         {'ru': 'Название, тип, город и телефон. Кабинет готов сразу — без договоров и оборудования.', 'uz': 'Nom, tur, shahar va telefon raqami. Shaxsiy kabinet darhol tayyor boʻladi — hech qanday shartnoma va uskunalarsiz.', 'en': 'Name, type, city and phone. The dashboard is ready at once — no contracts or hardware.'},
    'l_how2_t':         {'ru': 'Добавьте меню', 'uz': 'Menyu qoʻshing', 'en': 'Add your menu'},
    'l_how2_d':         {'ru': 'Блюда, фото и цены на трёх языках. Можно импортировать готовый список одним файлом.', 'uz': 'Uch tildagi taomlar, rasmlar va narxlar. Tayyor roʻyxatni bitta fayl orqali yuklab olishingiz ham mumkin.', 'en': 'Dishes, photos and prices in three languages. You can import a ready list with a single file.'},
    'l_how3_t':         {'ru': 'Распечатайте QR на столы', 'uz': 'Stollar uchun QR-kodlarni chop eting', 'en': 'Print QR for tables'},
    'l_how3_d':         {'ru': 'Скачайте готовые таблички с QR для каждого стола — и принимайте первые заказы.', 'uz': 'Har bir stol uchun tayyor QR-kodli peshtaxtalarni yuklab oling va ilk buyurtmalarni qabul qilishni boshlang.', 'en': 'Download ready QR table-tents for each table — and start taking your first orders.'},
    ...
    # registration block
    'l_reg_h2':         {'ru': 'Подключите заведение', 'uz': 'Kafeni 5 daqiqada', 'en': 'Connect your venue'},
    'l_reg_h2_accent':  {'ru': 'за 5 минут', 'uz': 'tizimga ulang', 'en': 'in 5 minutes'},
    'l_reg_p':          {'ru': 'Заполните короткую форму — и сразу попадёте в кабинет, где можно добавить меню и получить QR-коды для столов.', 'uz': 'Qisqa shaklni toʻldiring va darhol menyu qoʻshish, QR-kodlarni olish mumkin boʻlgan kabinetga oʻtasiz.', 'en': 'Fill in a short form — and land straight in the dashboard, where you can add a menu and get QR codes for tables.'},
    'l_reg_b1_t':       {'ru': 'Подключение за 5 минут', 'uz': '5 daqiqada ulanish', 'en': 'Set up in 5 minutes'},
    'l_reg_b1_d':       {'ru': 'Без договоров и оборудования — нужен только телефон.', 'uz': 'Shartnoma va jihozsiz — faqat telefon kifoya.', 'en': 'No contracts or hardware — just a phone.'},
    'l_reg_b2_t':       {'ru': 'Поможем перенести меню', 'uz': 'Menyuni kiritishda yordam beramiz', 'en': 'We’ll help move your menu'},
    'l_reg_b2_d':       {'ru': 'Пришлите фото бумажного меню — заполним за вас.', 'uz': 'Qogʻoz menyu rasmini yuboring — uni oʻzimiz toʻldirib beramiz.', 'en': 'Send a photo of your paper menu — we’ll fill it in for you.'},
    'l_reg_b3_t':       {'ru': 'Поддержка на русском и узбекском', 'uz': 'Rus va oʻzbek tillarida qoʻllab-quvvatlash xizmati', 'en': 'Support in Russian and Uzbek'},
    'l_reg_b3_d':       {'ru': 'Отвечаем в Telegram в течение часа.', 'uz': 'Telegram orqali bir soat ichida javob beramiz.', 'en': 'We reply on Telegram within an hour.'},
    ...
    'l_reg_submit':     {'ru': 'Оставить заявку', 'uz': 'Ariza qoldirish', 'en': 'Leave a request'},
